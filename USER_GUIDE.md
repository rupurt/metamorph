...
3. Error and recovery path
   - Metamorph should fail with clear messages when a format is unsupported, a path is lossy without opt-in, a remote source is missing from cache, or the output layout is invalid.
